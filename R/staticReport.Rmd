...
duplicatedRows
tradeStatsNoDup<- tradeStats[-duplicatedRows, ] #something wrong with this code
...
banknotes<- tradeStatsCommodities[tradeStatsCommodities$HS.Code== 49070010, ] 
tradeStatsNoBanknotes<- tradeStatsCommodities[-banknotes, ] #something wrong with code 
