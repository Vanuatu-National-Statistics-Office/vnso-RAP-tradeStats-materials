...
library(janitor) # Converting excel figures to dates
...
tradeStats$Reg..Date <- as.numeric(tradeStats$Reg..Date) 
tradeStats$Reg..Date <- excel_numeric_to_date(tradeStats$Reg..Date) 
