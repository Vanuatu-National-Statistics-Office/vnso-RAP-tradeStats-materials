...
# TO DO:
# Add code to clear formatting of all rows after header
# Add bold formatting to Annually and Monthly table headers
# Add formatting to the notes section below
```
