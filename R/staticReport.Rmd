...
mergedCountryImport<- merge(countryDescritpionImports, mergedSITCDescription, by= "CO")
...
mergedCountryExport<- merge(countryDescritpionExports, mergedCountryImport, by= "CE/CD")
...
mergedPrincipleCommodity<- merge(principleCommodityClassification, mergedCountryExport, by= "HS.Code")
...
mergedBECDescriptions<- merge(becDescriptions, mergedPrincipleCommodity, by= "HS.Code_6")
...
# Processed data set stored
processedTradeStats<- mergedPrincipleCommodity
...
# Build the table
exportsByHS <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
# Build the table
reExportsByHS <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
# Build the table
totalPrincipleExports <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
# Build the table
totalPrincipleReExports <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)

# View the table
prettyTable(totalPrincipleReExports)
...
# Build the table
totalPrincipleImports <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
columnCategories <- list(
  ...
  "All Others: Exports"=c("ALL OTHERS")
)

# Build the table
totalPartnerCountryExports <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
columnCategories <- list(
  ...
  "All Others: Imports"=c("ALL OTHERS")
)

# Build the table
totalPartnerCountryImports <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
# Build the table
totalPartnerRegionExports <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
# Build the table
totalPartnerRegionImports <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
columnCategories <- list(
  "Air: Exports"=c("AIR"),
  "Water: Exports"=c("WATER"),
  "Land: Exports"=c("LAND"),
  "Postal: Exports"=c("POSTAL"),
  "Other: Exports"=c("OTHER")
)

# Build the table
totalTransportExports <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
columnCategories <- list(
  "Air: Imports"=c("AIR"),
  "Water: Imports"=c("WATER"),
  "Land: Imports"=c("LAND"),
  "Postal: Imports"=c("POSTAL"),
  "Other: Imports"=c("OTHER")
)

# Build the table
totalTransportImports <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
# Define the categories used for each column
categoryColumn <- "SITC Description"
columnCategories <- list(
...
# Build the table
totalExportsbySITC <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
...
# Build the table
totalImportsbySITC <- buildRawSummaryTable(processTradeStats, codesCP4, categoryColumn, columnCategories)
