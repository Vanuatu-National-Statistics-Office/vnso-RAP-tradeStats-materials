...
principleExportsTable <- read.xlsx(finalWorkbookFileName, sheet="6_PrinX", rows=5:31, cols=1:33)
...
# Extract the table from the formatted excel sheet
principleImportsTable <- read.xlsx(finalWorkbookFileName, sheet="7_PrinM", rows=5:53, cols=1:33)
...
# Extract the table from the formatted excel sheet
balanceOfTradeMajorTable <- read.xlsx(finalWorkbookFileName, sheet="8_BOT_PC", rows=5:71, cols=1:34)

# Add the latest month's statistics
balanceOfTradeMajorTable <- updateTableByCommodity(balanceOfTradeMajorTable, month, year, 
                                                   newStatistics=balanceOfTradeByMajorPartnerCountries / 1000000, 
