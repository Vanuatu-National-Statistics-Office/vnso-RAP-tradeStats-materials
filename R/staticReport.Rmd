...
# Update the sub tables
tradeByModeOfTransportSubTables <- updateSubTablesByTime(tradeByModeOfTransportSubTables, month, year, tradeByModeOfTransport/1000000)
...
```{r insert balance of trade by Region into final formatted table}
# Extract the table from the formatted excel sheet
totalExportsbySITCTable <- read.xlsx(finalWorkbookFileName, sheet="12_X_SITC", rows=5:16)
...
```{r insert balance of trade by Region into final formatted table}
# Extract the table from the formatted excel sheet
totalImportsbySITCTable <- read.xlsx(finalWorkbookFileName, sheet="13_M_SITC", rows=5:16)
