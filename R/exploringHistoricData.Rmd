...
write.table(exports, file=file.path(repository, "data", "secure", "tradeStats_historic_EXPORTS_14-09-20.csv"),
            sep=",", row.names=FALSE, quote=TRUE)
write.table(imports, file=file.path(repository, "data", "secure", "tradeStats_historic_IMPORTS_14-09-20.csv"),
            sep=",", row.names=FALSE, quote=TRUE)
```
