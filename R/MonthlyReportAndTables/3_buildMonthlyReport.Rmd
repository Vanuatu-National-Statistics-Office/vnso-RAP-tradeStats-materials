...
importSummarySummaryStats <- read.csv(importSummaryFile)
importSummarySummaryStats2016<- importSummarySummaryStats[importSummarySummaryStats$Year == "2016", ]
exportSummaryFile <- file.path(secureDataFolder,"exports_HS_summaryStats_02-10-20.csv")
exportSummarySummaryStats <- read.csv(exportSummaryFile)
exportSummarySummaryStats2016<- exportSummarySummaryStats[exportSummarySummaryStats$Year == "2016", ]

# Calculate value of trade by major partner countries per month 
