...
# Calculate Proxy for ECO 1.6.2 Total estimated value of trade agreement as a proportion of GDP (all exports included to MSG countries, and GDP taken from 2018)
...
msgProxyExportValue2019 <- importsAndExports2019Commodities[importsAndExports2019Commodities$EXPORT.COUNTRY %in% c("FIJI", "NEW CALEDONIA", "PAPUA NEW GUINEA", "SOLOMON ISLANDS"), ] #need to exclude re-exports from this calculation
