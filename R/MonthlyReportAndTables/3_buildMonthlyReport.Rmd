...
cacheFile <- file.path(repository, "data", "secure", "report_environment_cache.RData")
if(params$useCache == FALSE || file.exists(cacheFile) == FALSE){
  
  # Load the processed trade statistics for month of interest
  processedTradeStats <- read.csv(file.path(secureDataFolder, "OUT_PROC_ASY_ProcessedRawData_31-07-21.csv"))
...
write.csv(importSubstitutionDataFrame, "DARD.csv")
...
indicatorsTable
```
Total value of imports targeted by Department of Agriculture and Rural Development (DARD) as those that can be produced domestically is VT 3.66 million (ENV 1.3.1). The products imported included Potatoes (VT 0.12 million), Tomatoes (VT 0.33 million), Onions and Shallots (VT 0.04 million), Cauliflower and Broccoli (VT 0.30 million), Carrots and Turnips (VT 1.18 million), Capsicum (VT 0.23 million), and Oranges (VT 1.47 million). 

The total value of the Melanesian Spearhead Group (MSG) agreement is VT 176.79 million (ECO 1.5.2). This Trade-by-Trade agreement included total exports of VT 72.34 million and total imports of VT 104.45 million. The Balance of Trade by Major Partner Countries is VT -2,477.60 million (ECO 1.5.3). Based on the 2019 Gross Domestic Product (GDP) VT 107,450 million, the total estimated value of trade agreement as proportion of GDP is 0.16% (ECO 1.6.2). 

Level of production of major commodities is VT 360.01 million (ECO 1.7.1). The major commodities included Beef (VT 29.64 million), Cocoa (VT 49.34 million), Coconut Oil (VT 6.33 million), Coffee (VT 0.89 million), Copra (VT 35.56 million), Kava (VT 146.54 million) and Wood (VT 91.72 million). The ratio of processed export commodities including coconut, kava, cocoa, and coffee to raw exports is 1.17 (ECO 4.3.2). Total value of processed exports is VT 128.14 million and total value of raw exports is VT 109.63 million. 
...
Balance of trade by major partner countries is VT -2,477.60 million. The main countries that account for this Balance are Australia (VT -613.51 million), China (VT -353.95 million), Japan (VT -113.82 million), Singapore (VT -806.02 million) and Thailand (VT -159.65 million). These countries represent 82.61% of the total Balance by Major Partner Countries (VT -2046.95 million).

Major imports from Australia were Machinery & Electrical Appliances (VT 141.88 million); and Prepared Foodstuffs, Beverages, Alcohol, and Tobacco (VT 97.24 million). Major imports from China were Machinery and Electrical Appliances (VT 156.75 million), and Base Metals (VT 91.76 million). Major imports from Japan were Vehicles and Transport Equipment (VT 78.83 million), and Machinery and Electrical Appliances (VT 27.86 million). Major imports from Singapore were Mineral Products (VT 785.69 million); and Prepared Foodstuffs, Beverages, Alcohol, and Tobacco (VT 15.73 million). Major imports from Thailand were Vehicles and Transport Equipment (VT 117.06 million), and Plastics and Rubbers (VT 10.27 million). 
...
```
Total Trade Balance of Pacific Islands excluding Melanesia, Australia and New Zealand is VT 4.23 million. This was driven by Medicaments to Kiribati (VT 2.75 million), Kava to Samoa (VT 1.01 million), and Steel Bars to Tonga (VT 0.39 million, Total Exports VT 0.47 million). 
...
tradeByTradeTable
```
The major imports from Fiji are Wheat or Meslin Flour (VT 19.48 million), and Bread, Cakes, Pastry and Biscuits (VT 11.86 million). The major imports from Papua New Guinea is Prepared or Preserved Fish (VT 7.11 million), and from the Solomon Islands is also Prepared or Preserved Fish (VT 14.25 million). 

The major export to Fiji is Kava (VT 71.54 million), to Papua New Guinea is Beef (VT 7.84 million), and to Solomon Islands is also Beef (VT 13.99 million). 
...
The level of production of the top five Major Principal Exports is VT 267.41 million. The Principal Exports identified included Beef (VT 29.64 million), Cocoa (VT 49.34 million), Coconut Oil (VT 6.33 million), Coffee (VT 0.89 million), Copra (VT 35.56 million), and Kava (VT 146.54 million). 

The main country of destination for Beef was the Solomon Islands (VT 13.99 million). The major country of destination for Cocoa is Malaysia (VT 43.19 million), for Coconut Oil is Fiji (VT 6.24 million), and Copra is United Arab Emirates (VT 35.56 million). Kava is exported mainly to Fiji (VT 71.54 million), New Caledonia (VT 43.00 million), and New Zealand (VT 14.24 million). 
...
Total value of Roadmaking Machine VT 8.56 million, Scrap Metal VT 5.81 million, Pharmaceuticals VT 4.01 million, Automatic Data Processing Machine VT 3.55 million, and Recycled Metal VT 3.23 million. 
...
Total value of top five Principal imports is VT 1061 million. The Principal Imports included Alcoholic Drinks (VT 44 million), Articles of Iron and Steel (VT 122 million), Medicaments (VT 48 million), Petroleum Oils (VT 787 million), and Rice (VT 60 million).

The main country of origin for Alcoholic Drinks is Australia (VT 27.04 million). The main country of origin for Articles of Iron and Steel is China (VT 56.34 million), and Medicaments is Australia (VT 13.47 million). The main country of origin for Petroleum Oils is Singapore (VT 784.55 million), and Rice is Taiwan (VT 32.27 million). 
...
Total value of Timber Short Landed VT 23.54 million, Interior Construction Materials VT 17.90 million, Insulation VT 14.65 million, Tractor with Front Loader VT 14.43 million, and Prefab Building VT 10.36 million. 
...
Total value of Bakery Products is VT 35.28 million and are mainly imported from Fiji (VT 11.86 million). Total value of Canned Meats is VT 11.50 million and are mainly imported from Australia (VT 11.05 million). Total value of Confectionary is VT 23.99 million and are mainly imported from Australia (VT 15.46 million). Total value of Cordial is VT 13.61 million and are mainly imported from Malaysia (VT 4.50 million). Total value of Noodles is VT 17.13 million and are mainly imported from Indonesia (VT 5.87 million). 
...
Total value of Chicken is VT 40.68 million and are mainly imported from Australia (VT 37.71 million). Total value of Canned Tunas is VT 24.04 million and are mainly imported from Solomon Islands (VT 14.25 million). Total value of Canned Mackerel is VT 4.30 million and are mainly imported from China (VT 3.80 million). Total value of Chicken Eggs VT 0.92 million and are mainly imported from New Zealand (VT 0.92 million).  
