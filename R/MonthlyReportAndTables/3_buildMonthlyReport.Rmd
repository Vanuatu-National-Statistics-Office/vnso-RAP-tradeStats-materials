...
indicatorsTable <- add_header_row(indicatorsTable, top=TRUE, 
                     values=c("NATIONAL SUSTAINABLE DEVELOPMENT PLAN: Key Indicators Aligned to International Merchandise Trade\nNOTE: SMART Indicators calculated for the current month, and Target Percentage is an estimation of change between current month and same month during baseline year (2016)"),
