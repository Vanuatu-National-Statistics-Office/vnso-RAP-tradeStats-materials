...
# Calculate ECO 1.5.2 Trade by trade agreement (proxy- all exports too MSG countries)
...
# Calculate ECO 1.7.1 Level of production of major commodities to include Cocoa and Copra (proxy)
...
subsetExportsNewEmergingMarkets <- processedTradeStats[processedTradeStats$EXPORT.PARTNER.COUNTRIES== "OTHERS"] #this code isn't working
