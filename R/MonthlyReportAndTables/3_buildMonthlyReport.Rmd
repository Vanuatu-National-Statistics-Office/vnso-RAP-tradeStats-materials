...
# Read in the data from the secure folder of the repository (need to calculate baseline indicators- Trade Agreements not registered in Customs system in 2016 so baseline data taken from 2019)
...
# Create subset of all international exports to MSG countries in 2019
...
tradeStatsMSGExports2019$Stat..Value <- as.numeric(gsub(",", "", tradeStatsMSGExports2019$Stat..Value))# Convert the statistical value to numeric
totalMonthlyValueTradeAgreementsExports <- tradeStatsMSGExports2019 %>%
  group_by(Month) %>%
...
percentageChangeJanuaryMSGExports<- ((tradeAgreementProxyExportValue - tradeAgreementJanuary2019)/tradeAgreementJanuary2019)*100 # needs to be 15% to meet Target
