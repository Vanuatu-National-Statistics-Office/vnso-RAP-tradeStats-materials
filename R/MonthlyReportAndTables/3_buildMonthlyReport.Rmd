...
colnames(historicalImports)[6] <- "HS.Code"
historicalImports$HS.Code <- sapply(historicalImports$HS.Code, FUN=padWithZeros, "HS")
historicalHealthMergedWithClassifications <- merge(historicalImports, productsRelatedHealth, by="HS.Code", all.x=TRUE)
