...
proxyIndicatorCalculated1.5.2<- tradeAgreementCurrentMonthlyImportValue + tradeAgreementCurrentMonthlyExportValue

# Insert values into table
proxyIndicator1.5.2DataFrame <- data.frame("Trade by Trade Agreement Value"= proxyIndicatorCalculated1.5.2)
...
# Build the table
majorPartnerCountryExportsValue <- buildRawSummaryTable(processedTradeStats, codesCP4, categoryColumn, columnCategories)
...
# Build the table
majorPartnerCountryImportValue <- buildRawSummaryTable(processedTradeStats, codesCP4, categoryColumn, columnCategories)
