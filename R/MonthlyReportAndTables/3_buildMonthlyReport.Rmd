...
importSubstitutionValue<- sum(importSubstitutionDataFrame$Stat..Value)

# Insert values into table
proxyCurrentMonthIndicator1.3.1 <- data.frame("Value of imports of food and products targeted by DARD"= tradeAgreementCurrentMonthlyExportValue)
...
allMSGCountryExports <- msgCommoditiesExcludeMerged[msgCommoditiesExcludeMerged$CP4 == 1000 & msgCommoditiesExcludeMerged$EXPORT.COUNTRY %in% c("FIJI", "NEW CALEDONIA", "PAPUA NEW GUINEA", "SOLOMON ISLANDS"), ]
tradeAgreementCurrentMonthlyExports <- allMSGCountryExports[is.na(allMSGCountryExports$Not.Included.in.MSG) == TRUE, ]
tradeAgreementCurrentMonthlyExportValue<- sum(tradeAgreementCurrentMonthlyExports$Stat..Value)

# Proxy indicator calculated for NSDP indicator ECO 1.5.2 by combining imports and proxy exports
proxyIndicatorCurrentMonth1.5.2<- tradeAgreementCurrentMonthlyImportValue + tradeAgreementCurrentMonthlyExportValue

# Insert values into table
proxyCurrentMonthIndicator1.5.2 <- data.frame("Trade by Trade Agreement Monthly Value"= proxyIndicatorCurrentMonth1.5.2)
...
totalMajorPartnerCountryCurrentMonthImportValue<- majorPartnerCountryCurrentMonthImportValue$Total

# Indicator calculated for NSDP indicator ECO 1.5.3 by subtracting total imports from exports 
monthlyBalanceOfTradeByMajorPartnerCountries <- totalMajorPartnerCountryCurrentMonthExportValue - totalMajorPartnerCountryCurrentMonthImportValue

# Insert values into table
currentMonthindicator1.5.3 <- data.frame("Current Month Balance of Trade by Major Partner Countries"= monthlyBalanceOfTradeByMajorPartnerCountries)
...
proxyCurrentMonthIndicator1.6.2<- (proxyIndicatorCurrentMonth1.5.2/mostRecentGrossDomesticProduct)*100

# Insert values into table as a percentage to 2 decimal places
proxyCurrentMonthIndicator1.6.2Rounded<- round(proxyCurrentMonthIndicator1.6.2, digits = 2)
proxyCurrentMonthIndictaor1.6.2<- data.frame("Value of Trade Agreement as Proportion of GDP for Current Month"= proxyCurrentMonthIndicator1.6.2Rounded)
...
proxyCurrentMonthIndicator1.7.1 <- data.frame("Level of production of major commodities to include Cocoa and Copra for Current Month"= proxyIndicator1.7.1CurrentMonthValue)
...
proxyCurrentMonthIndicator4.3.2Calculated<- (processed/raw)
...
## ENV 1.1.3 Total annual volume of imports of food and products targeted by DARD as those that can be produced domestically (including ‘value-added products), Target to be decided after baseline established (baseline taken from 2016) 
## Proxy calculated: Value of imports of food and products targeted by DARD, no target given

# Read in the data from the baseline data (2016) from the open folder of the repository 
...
# Calculate ENV 1.1.3 Value of imports of food and products targeted by DARD,  
proxyIndicatorENV1.1.3TargetCurrentMonth<- ((importSubstitutionValue - baselineDARDImportsCurrentMonth)/baselineDARDImportsCurrentMonth)*100 # needs to be 15% to meet Target

# Insert values into table as a percentage to 2 decimal places
proxyIndicatorENV1.1.3TargetCurrentMonthRounded<- round(proxyIndicatorENV1.1.3TargetCurrentMonth, digits = 2)
proxyIndicatorENV1.1.3TargetCurrentMonthDataFrame <- data.frame("Percentage Change in DARD targetted imports)"= proxyIndicatorENV1.1.3TargetCurrentMonthRounded)
...
tradeAgreementCurrentMonthBaselineValue <- sum(baselineMSGExports[baselineMSGExports$Month == "January", "Total.VT"], na.rm= TRUE)

# Calculate ECO 1.5.2 Trade by trade agreement (value), Target 2020 exports increase by 15% 
proxyIndicator1.5.2TargetCurrentMonth<- ((proxyIndicatorCurrentMonth1.5.2 - tradeAgreementCurrentMonthBaselineValue)/tradeAgreementCurrentMonthBaselineValue)*100 # needs to be 15% to meet Target

# Insert values into table as a percentage to 2 decimal places
proxyIndicator1.5.2TargetCurrentMonthRounded<- round(proxyIndicator1.5.2TargetCurrentMonth, digits = 2)
proxyIndicator1.6.2CurrentMonthDataFrame <- data.frame("Percentage Change in exports for Current month compared to Baseline)"= proxyIndicator1.5.2TargetCurrentMonthRounded)
...
historicalDataCurrentMonthlyValueMajorPartnerCountryExports<- baselineBalanceTrade[baselineBalanceTrade$Month == "January", ]
historicalMonthlyExportValueproxyIndicator1.5.3Target<- historicalDataCurrentMonthlyValueMajorPartnerCountryExports$Total.VT

# Calculate ECO 1.5.3 Balance of Trade by major partner countries, Target 2020 exports increase by 20%
proxyIndicator1.5.3TargetCurrentMonth<- ((monthlyBalanceOfTradeByMajorPartnerCountries - historicalMonthlyExportValueproxyIndicator1.5.3Target)/historicalMonthlyExportValueproxyIndicator1.5.3Target)*100 # needs to reach 20% Target
...
GDP <- timeSeriesGrossDomesticProduct[nrow(timeSeriesGrossDomesticProduct), "Value"] 
GDP2016<- timeSeriesGrossDomesticProduct[timeSeriesGrossDomesticProduct$Year == "2016", "Value" ]
tradeAgreementCurrentMonthBaselineValue <- sum(baselineMSGExports[baselineMSGExports$Month == "January", "Total.VT"], na.rm= TRUE)
proxyIndicator1.6.2CurrentMonthBaseline<- (tradeAgreementCurrentMonthBaselineValue/GDP2016)*100

# Calculate ECO 1.6.2 Total estimated value of trade agreement as proportion of GDP, Target sets an increase by 15% by 2030
proxyIndicator1.6.2TargetCurrentMonth<- ((proxyCurrentMonthIndicator1.6.2 - proxyIndicator1.6.2CurrentMonthBaseline)/proxyIndicator1.6.2CurrentMonthBaseline)*100 # needs to be 15% to meet Target
...
# Calculate current monthly value
historicalDataCurrentMonthlyValueMajorProductionExports<- baselineProductionExports[baselineProductionExports$Month == "January", ]
historicalMonthlyExportValueproxyIndicator1.7.1Target<- historicalDataCurrentMonthlyValueMajorPartnerCountryExports$Total.VT

# Calculate ECO 1.7.1 Balance of Trade by major partner countries, Target 2020 exports increase by 20%
proxyIndicator1.7.1TargetCurrentMonth<- ((proxyIndicator1.7.1CurrentMonthValue - historicalMonthlyExportValueproxyIndicator1.7.1Target)/historicalMonthlyExportValueproxyIndicator1.7.1Target)*100 # needs to reach 20% Target

# Insert values into table as a percentage to 2 decimal places
proxyIndicator1.7.1TargetCurrentMonthRounded<- round(proxyIndicator1.7.1TargetCurrentMonth, digits = 2)
proxyIndicator1.7.1TargetCurrentMonthDataFrame <- data.frame("Percentage Change in exports for Current month compared to Baseline)"= proxyIndicator1.7.1TargetCurrentMonthRounded)
...
historicProxyCurrentMonthIndicator4.3.2Calculated<- (processed/raw)

# Calculate ECO 4.3.2, Target by 2020 increase 15%
proxyIndicator4.3.2TargetCurrentMonth<- ((proxyCurrentMonthIndicator4.3.2Calculated - historicProxyCurrentMonthIndicator4.3.2Calculated)/historicProxyCurrentMonthIndicator4.3.2Calculated)*100 # needs to reach 20% Target

# Insert values into table as a percentage to 2 decimal places
proxyIndicator4.3.2TargetCurrentMonthRounded<- round(proxyIndicator4.3.2TargetCurrentMonth, digits = 2)
proxyIndicator4.3.2TargetCurrentMonthDataFrame <- data.frame("Percentage Change in exports for Current month compared to Baseline)"= proxyIndicator4.3.2TargetCurrentMonthRounded)
