...
proxyIndicatorCurrentMonth1.5.2DataFrame <- data.frame("Trade by Trade Agreement Value"= proxyIndicator1.5.2CurrentMonth)
...
# Insert values into table
indicator1.5.3DataFrame <- data.frame("Balance of Trade by Major Partner Countries"= indicator1.5.3Calculated)
...
proxyIndicatorCalculated1.6.2<- (proxyIndicatorCalculated1.5.2/mostRecentGrossDomesticProduct)*100

# Insert values into table as a percentage to 2 decimal places
proxyIndicatorCalculated1.6.2<- round(proxyIndicatorCalculated1.6.2, digits = 2)
proxyIndictaor1.6.2DataFrame <- data.frame("Value of Trade Agreement as Proportion of GDP"= proxyIndicatorCalculated1.6.2)
...
currentMonthlyValueMajorPartnerCountryExports<- totalMonthlyValueMajorPartnerCountryExports[totalMonthlyValueMajorPartnerCountryExports$Month == 1, ]

# Calculate ECO 1.5.3 Balance of Trade by major partner countries, Target 2020 exports increase by 20% 
percentageChangeCurrentMonthMajorPartnerCountries<- ((currentMonthlyValueMajorPartnerCountryExports$total - totalMajorPartnerCountryExports$Total)/totalMajorPartnerCountryExports$Total)*100 # needs to be 20% to meet Target
