...
# Calculate value of exports that are destined to countries that have signed trade agreement (MSG)
...
importsAndExports2017File <- file.path(secureDataFolder,"SEC_PROC_ASY_RawDataAndReferenceTables_CompleteImportExport2017.csv")
importsAndExports2017 <- read.csv(importsAndExports2017File)
importsAndExports2017Commodities <- importsAndExports2017[importsAndExports2017$Procedure %in% c(1000, 3071, 4000, 4071, 7100), ]

totalMonthlyValueByMonthAndExport <- importsAndExports2017Commodities %>%
  group_by(Month, Procedure) %>%
  summarise(total = sum(Value))

exports2017Commodities <- totalMonthlyValueByMonthAndExport[totalMonthlyValueByMonthAndExport$Procedure %in% c(1000), ]

exportsJanuary2017 <- sum(exports2017Commodities[exports2017Commodities$Month == 1, "total"], na.rm=TRUE)
exportsJanuary2020 <- sum(processedTradeStats[processedTradeStats$CP4 == 1000, "Stat..Value"], na.rm=TRUE)
percentageChangeJanuaryExports<- (exportsJanuary2020/exportsJanuary2017)*100 # needs to be 120% to meet Target
...
importsAndExports2019Commodities <- importsAndExports2019[importsAndExports2019$CP4 %in% c(1000, 3071, 4000, 4071, 7100), ]

tradeStatsForMSG2019 <- importsAndExports2019Commodities[is.na(importsAndExports2019Commodities$PRF) == FALSE & importsAndExports2019Commodities$PRF == "MSG", ]

msgProxyExportValue2019 <- importsAndExports2019Commodities[importsAndExports2019Commodities$CE.CD %in% c("FJ", "NC", "PG", "SB"), ] #need to exclude re-exports from this calculation
