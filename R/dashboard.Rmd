...
```{r Load files}
toptenexport <- read.csv("C:/DataViz/Trades/data/secure/tab.csv")
countryYearExport <- read.csv("C:/DataViz/Trades/data/secure/country_export.csv")
curtrade <- read.csv("C:/DataViz/Trades/data/secure/curtrade.csv")
exp <- read.csv("C:/DataViz/Trades/data/secure/country_year_export.csv")
imp <- read.csv("C:/DataViz/Trades/data/secure/country_year_import.csv")
services <- read.csv("C:/DataViz/Trades/data/secure/tblservices.csv")
trades <- read.csv("C:/DataViz/Trades/data/secure/trades.csv")
...
updateCountryExport <- reactive(
  countryExport %>% group_by(!!! rlang::syms(input$CE)) %>% summarise_if(is.numeric,sum,na.rm=T))
```
...
renderPlot({
 updateCountryExport() %>% 
  ggplot(aes(x=!! rlang::sym(input$CE),y=!! rlang::sym(input$Metric_two),fill=!! rlang::sym(input$CE))) +
  geom_col()
})
```
